		...
		<main id="main">
			...
			<div class="container">
				<div class="flex-col justify-start items-start gap-[18px] inline-flex">
					<h1 class="sm:text-[38px] font-bold">Результаты поиска по: «<?php echo $search_query; ?>»</h1>
				</div>
			</div>
					...
					<section class="product-cards w-full" id="card_link">
						...
						<div class="flex flex-col">
							<div class="flex flex-col relative">
								<?php
									my_custom_template($search_query, 'template-parts/content/search-loop-excursion');
								?>
							</div>
						</div>
					</section>
